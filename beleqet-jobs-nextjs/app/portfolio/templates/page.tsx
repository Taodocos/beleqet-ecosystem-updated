    ...
    <div className="container-page space-y-8 py-8 md:py-12">
      <header className="max-w-2xl space-y-3">
        ...
        <p className="text-sm text-ink/70">
          Pick a layout to start. You can switch templates anytime — your content stays the same.
        </p>
      </header>

      <TemplateSelector selected="modern" locale={locale} onSelect={() => undefined} linkMode />

      <div>
        <Link
          href="/portfolio"
          className={cn(buttonVariants({ size: 'lg' }), 'inline-flex gap-2 rounded-xl px-5')}
        >
          {t('startBuilding')}
