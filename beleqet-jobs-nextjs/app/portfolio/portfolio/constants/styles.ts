...
export const LABEL_CLASS = 'block text-sm font-semibold text-ink';

export const SECTION_CARD_CLASS = 'rounded-2xl border border-primary/10 bg-white p-5 shadow-sm';
